...
//assert SIZE_OF_ARRAY is power of 2.
...
struct cpref__stream 
{
    ...
    signed long long current_ref_i;
...
void cpref__setup_write_stream(struct cpref__stream *stream, struct cpref__obj *cp, unsigned long long total_msgs);      // allocates meta storage area in file. 
