...
static char *STRINGS[] = {"abc", "abcd", "erm", "abc", "erq"};
static unsigned int STRING_LENS[] = {3, 4, 3, 3, 3};              // Done so we can test a null in middle string easy.

static char *SEARCH_STRINGS[] = {"erm", "not_there", "erq", "abc", "abcd", "abce"};
static unsigned int SEARCH_STRING_LENS[] = {3, 9, 3, 3, 4, 4};
